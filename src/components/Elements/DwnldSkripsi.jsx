...
export const DwnldSkripsi = (props) => {
  ...
  useEffect(() => {
    ...
    const fileTypes = isAuthenticated
      ? [
          ...
          { fileType: "fileJurnal", text: "Jurnal" },
          { fileType: "fileSKTA", text: "SKTA" },
          { fileType: "fileLembarBimbingan", text: "Lembar Bimbingan" },
          { fileType: "fileLembarPersetujuan", text: "Lembar Persetujuan" },
          { fileType: "fileLembarPengesahan", text: "Lembar Pengesahan" },
        ]
      : [
          { fileType: "fileAbstrak", text: "Abstrak" },
          { fileType: "fileJurnal", text: "Jurnal" },
  ...
  const downloadFile = async (fileType) => {
    try {
      const response = await fetch(`http://localhost/php/downloadSkripsi.php?search=${selectedItem.nim}&fileType=${fileType}`);
