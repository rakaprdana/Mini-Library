...
import { TablePKl } from "../components/Fragments/TablePKl";

export const HomePagePKL = () => {
...
useEffect(() => {
  ...
  const handleClick = async (result) => {
    ...
    window.location.href = `/detail-pkl?search=${encodeURIComponent(result.nim)}`;
  };
  return (
    <div
    ...
    >
      ...
      <div className="w-full  flex flex-grow justify-center">
        <TablePKl searchResults={searchResults} handleClick={handleClick} />
      </div>
    </div>
  );
};
